...
void menu() {
	...
	printf("-m mode     mode of search for cryptos. (bsgs, xpoint, rmd160, address, vanity, bsgs-mt) default: address\n");
	...
	printf("\n[bsgs-mt mode]\n");
	printf("  -m bsgs-mt          Multi-target Baby-Step Giant-Step (millions of pubkeys)\n");
	printf("  Uses: -f, -r, -t and the options below\n");
	printf("  -J <m>              Baby table size m (absolute integer; e.g., 268435456 for 2^28)\n");
	printf("  -W <n>              Inner block size (default 8192)\n");
	printf("  -Y <kind>           Membership: tag+exact | bloom (default tag+exact)\n");
	printf("  -P <p>              Bloom false-positive probability (default 1e-9)\n");
	printf("  -U <mode>           NUMA: auto | off | nodes=0,1   (Linux)\n");
	printf("  -L <policy>         NUMA policy: local | interleave (Linux)\n");
	printf("  -H <on|off>         Hugepages madvise (Linux; default off)\n");
	printf("\nExamples (bsgs-mt):\n");
	printf("  ./keyhunt -m bsgs-mt -f pubkeys.txt \\\n");
	printf("           -r 4000000000000000000000000000000000:7fffffffffffffffffffffffffffffffff \\\n");
	printf("           -t 28 -J 268435456 -W 8192 -Y tag+exact -U auto -L local -H off\n");
	printf("  keyhunt.exe -m bsgs-mt -f pubkeys.txt -r <start:end> -t 24 -J 268435456 -W 8192 -Y tag+exact\n");
	printf("\nExample:\n\n");
